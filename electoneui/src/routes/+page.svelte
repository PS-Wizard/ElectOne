    ...
    <header class="absolute inset-x-0 top-0 z-50">
        ...
        >
            ...
            <div class="hidden lg:flex lg:gap-x-12">
                <a href="/" class="text-sm/6 font-medium text-white">Features</a
                >
                <a href="/" class="text-sm/6 font-medium text-white">About</a>
            </div>
        ...
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div class="text-center">
                ...
                <div class="mt-10 flex items-center justify-center gap-x-6">
                    <a
                        href="#"
                        class="rounded-md bg-fg-primary px-3.5 py-2.5 text-sm font-semibold text-black shadow-xs hover:bg-black hover:text-white transition-all duration-300 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                    >
                        Get started
                    </a>
                    <a href="#" class="text-sm/6 font-semibold text-white"
